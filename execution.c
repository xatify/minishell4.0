...
/*   Updated: 2021/01/22 12:42:26 by abbouzid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int    execute_pipeline(t_data *data, t_pipeline *pipeline)
// {
//     int     tmp_in;
//     int     exit_status;
//     int     tmp_out;
...
//                 data->exit_status = execute_pipeline(data, pipeline);
//             else
//                 data->exit_status=  execute_simple_cmd(data, pipeline->simple_cmd);
//         }
